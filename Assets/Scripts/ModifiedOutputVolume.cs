...
public class ModifiedOutputVolume : MonoBehaviour
{
    ...
    {
        PrefabBar, ObjectPosition, ObjectRotation, ObjectScale, Value
    }
    ...
    /// <summary>
    /// UI Element - text based on value
    /// </summary>
    [Tooltip("Text to modify")]
    public TMPro.TextMeshPro UIText;
    /// <summary>
    /// The minimum (low value) when outputType is Value.
    /// </summary>
    [Tooltip("The minimum (low value) ")]
    public float MinValue = 0.0f;
    /// <summary>
    /// The maximum (high value) color when outputType is Value.
    /// </summary>
    [Tooltip("The maximum (high value) ")]
    ...
    void Start () {
        ...
        }else if(outputType == OutputType.Value)
        {

            UIText = GetComponent<TMPro.TextMeshPro>();
        }
    ...
    void Update () {
        ...
        switch (outputType)
        {
            ...
            case OutputType.Value:
                value = Mathf.RoundToInt(Mathf.Lerp(MinValue, MaxValue, newScale*3));
